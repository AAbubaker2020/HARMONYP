      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            {formStatus && (
              <p className="mt-4 text-green-600 font-bold">{formStatus}</p>
            )}
          </motion.div>
          ...
          >
            ...
            <p className="mb-6">6846 Alkhabr, Al Khobar, Saudi Arabia</p>
            ...
            {/* Follow Us Section */}
            <h3 className="text-xl font-bold mt-6 mb-4 gradient-text">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="bg-black text-white p-3 rounded-full hover:bg-gray-800">
