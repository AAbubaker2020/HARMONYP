          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-400">{language === "en" ? "6846 Alkhabr, Al Khobar, Saudi Arabia" : t("address")}</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-yellow-400" />
                <span className="text-sm text-gray-400">+966-533-33-9311</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-yellow-400" />
                <span className="text-sm text-gray-400">info@harmonyprecision.com</span>
              </li>
            </ul>
          </motion.div>
